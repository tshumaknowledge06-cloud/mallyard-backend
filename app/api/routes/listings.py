...
def delete_listing(
    ...
    # ✅ STEP 1: Get orders manually (NO relationship needed)
    orders = db.query(Order).filter(Order.listing_id == listing_id).all()
    order_ids = [o.id for o in orders]

    # ✅ STEP 2: Get delivery requests
